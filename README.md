...
It is planned to release a new **version 2.0.0** by end of November 2025. Pre-release versions will be released in the next time to test the library in advance, so please check [releases](https://github.com/dzimmer/PlanarMechanics/releases) from time to time when you are interested.
