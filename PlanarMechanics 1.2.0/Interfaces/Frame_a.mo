...
connector Frame_a
  ...
  annotation (Icon(graphics={
        ...
        Line(
          points={{0,20},{0,-20}},
          color={95,95,95},
          smooth=Smooth.None)}), Documentation(revisions="<html><p><img src=\"./Resources/Images/dlr_logo.png\"/> <b>Developed 2010-2014 at the DLR Institute of System Dynamics and Control</b> </p></html>",  info="<html>
