...
model FixedTranslation "A fixed translation between two components (rigid rod)"
  ...
  PlanarMechanics.Types.TransformationMatrix R=
    PlanarMechanics.Utilities.Transformations.RbyAngle(frame_a.phi) "Rotation matrix from world frame to frame_a";
...
//  sy0 = -sin(frame_a.phi)*sx + cos(frame_a.phi)*sy;
  r0 = PlanarMechanics.Utilities.Transformations.resolve2in1(frame_a.phi, r);
