...
model CraneCrabTo3Db "A planar damped crane crab in the multi-body world - case b)"
  ...
  Interfaces.PlanarTo3D adaptor3DtoPlanar annotation (Placement(transformation(extent={{46,8},{54,12}})));
equation
  ...
  connect(planarWorld.MBFrame_a, fixedRotation3D.frame_b) annotation (Line(
      ...
      color={95,95,95},
      thickness=0.5));
  connect(damper1D.flange_b, prismatic.axis) annotation (Line(points={{40,40},{40,16},{38,16}}, color={0,127,0}));
  connect(prismatic.frame_a, prismatic3D.frame_b) annotation (Line(
      points={{20,10},{-10,10}},
      color={95,95,95},
      thickness=0.5));
  connect(prismatic.frame_b, adaptor3DtoPlanar.frameMultiBody) annotation (Line(
      points={{40,10},{46,10}},
      color={95,95,95},
      thickness=0.5));
  connect(adaptor3DtoPlanar.framePlanar, body1.frame_a) annotation (Line(
      points={{54,10},{70,10}},
      color={95,95,95},
      thickness=0.5));
