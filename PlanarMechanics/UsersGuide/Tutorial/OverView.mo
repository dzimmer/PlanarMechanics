...
<p>Library <b>PlanarMechanics</b> is a <b>free</b> Modelica package providing 2-dimentional mechanical components to model <b>mechanical systems</b>, such as robots, mechanisms, vehicles, where MultiBody library is too complex to use. The main features of the library are:</p>
<p><ul>
...
<li><b>Built-in animation properties</b> of all components, such as joints, forces, bodies, sensors. It enables a easy visual check of the constructed model. What&apos;s more, in all models animation can be disabled respectively, while in the PlanarWorld model animations of  all models are able to be switched off.</li>
</ul></p>
</html>"));
end OverView;
