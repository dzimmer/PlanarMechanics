...
<ul>
  ...
  <li>
    ...
    outputs for translational and rotational movement, whereby
    <table border=\"1\" cellspacing=\"0\" cellpadding=\"2\">
      <tr>
        <th> old output</th>
        <th> new outputs</th>
    ...
    for AbsolutePosition sensor and similarly for all abovementioned sensors. The &quot;old&quot; outputs can still be
    conditionally enabled by the new boolean parameter <code>concatenateOutput</code>.
  </li>
</ul>
