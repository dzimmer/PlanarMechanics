...
model Test_resolve2in1_RotationalAcc "Test derivations of resolve2in1 for rotational movement - acceleration sensors"
  ...
  Modelica.Blocks.Sources.RealExpression exprVelocityOfBody[2](
    y=constantSpeed.w_fixed^2*fixedTranslation.r[1]*{-Modelica.Math.cos(revolute.phi),-Modelica.Math.sin(revolute.phi)})
...
equation
  ...
  connect(absoluteAcceleration.a[1:2], mustBeZeroAbs.u1) annotation (Line(points={{61,-10},{70,-10},{70,-14},{78,-14}}, color={0,0,127}));
  ...
  connect(relativeAcceleration.a_rel[1:2],mustBeZeroRel. u1) annotation (Line(points={{-20,-21},{-20,-66},{78,-66}}, color={0,0,127}));
  annotation (experiment(StopTime=1));
end Test_resolve2in1_RotationalAcc;
